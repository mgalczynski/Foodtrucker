...
curl -d '{"firstName":"Mirosław", "lastName":"Gałczyński", "email":"contact@miroslawgalczynski.com", "password":"P@ssw0rd1"}' -H "Content-Type: application/json" -X POST https://foodtrucker.miroslawgalczynski.com/api/auth/registerStaff
